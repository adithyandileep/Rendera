...
const Result = () => {
  ...
  return (
    ...
    className="flex flex-col min-h-[90vh] items-center justify-center">
      ...
      {isImageLoaded && (
        <div className="flex justify-center flex-wrap text-white text-sm p-0.5 rounded-full gap-2 mt-10">
          <p
            onClick={() => {
          ...
          <a
            download
            href={image}
            className="bg-zinc-900 px-10 cursor-pointer py-3 rounded-full"
          >
            Download
          </a>
        </div>
